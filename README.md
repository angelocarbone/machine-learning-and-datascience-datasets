...
## A great cheat sheet for high quality, and diverse machine learning datasets.

![machine-learning-and-datascience-datasets](./machine-learning-and-datascience-datasets.png)
...
[**Google Dataset Search**](https://toolbox.google.com/datasetsearch): Similar to how [Google Scholar](https://scholar.google.com/) works, Dataset Search lets you find datasets wherever they’re hosted, whether it’s a publisher’s site, a digital library, or an author’s personal web page.

[**Kaggle**](https://www.kaggle.com/): A data science site that contains a variety of externally contributed interesting datasets. You can find all kinds of niche datasets in its [master list](https://www.kaggle.com/datasets), from [ramen ratings](https://www.kaggle.com/residentmario/ramen-ratings) to [basketball data](https://www.kaggle.com/ncaa/ncaa-basketball) to [and even seattle pet licenses](https://www.kaggle.com/aaronschlegel/seattle-pet-licenses).
...
[**Boston Housing Dataset:**](https://www.cs.toronto.edu/~delve/data/boston/bostonDetail.html) **C**ontains information collected by the U.S Census Service concerning housing in the area of Boston Mass. It was obtained from the [StatLib archive](http://lib.stat.cmu.edu/datasets/boston), and has been used extensively throughout the literature to benchmark algorithms.
...
[**IMDB**](http://ai.stanford.edu/~amaas/data/sentiment/) **reviews**: An older, relatively small dataset for binary sentiment classification features 25,000 movie reviews.
...
[**Amazon Review**s](https://snap.stanford.edu/data/web-Amazon.html): Contains around 35 million reviews from Amazon spanning 18 years. Data include product and user information, ratings, and the plaintext review.
...
[**LISA: Laboratory for Intelligent & Safe Automobiles, UC San Diego Datasets**](http://cvrr.ucsd.edu/LISA/datasets.html): This dataset includes traffic signs, vehicles detection, traffic lights, and trajectory patterns.
...
If you are aware of other high-quality, public datasets, which you recommend to people for research and application of machine learning, deep learning, data science, etc. **Please Star this repository and Fork it**.
...
[9] [http://lib.stat.cmu.edu/datasets/](http://lib.stat.cmu.edu/datasets/)

[10] Institutional Research and Analysis | Common Datasets | https://www.cmu.edu/ira/CDS/index.html

[11] Datasets and Project Suggestions | Andrew W. Moore | [http://www.cs.cmu.edu/~awm/15781/project/data.html](http://www.cs.cmu.edu/~awm/15781/project/data.html)
...
[16] Datalab | UC Berkeley | [http://www.lib.berkeley.edu/libraries/data-lab](http://www.lib.berkeley.edu/libraries/data-lab)
